...
public class VoluntReg extends AppCompatActivity {

    EditText userN, pass, pass2, perName, addr, phone, email,qual;
    TextView l1, l2, l3, l4, l5, l6, l7,l8;
    Spinner gender;
    String user, password, name, address, thePhone, Email, type = "user",gen="male",Qual;
    String URL = Server.ip + "register_volunt.php";
    Button reg;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_volunt_reg);
        ...
        qual = findViewById(R.id.reg_qual);
    ...
    public void RegOnclick(View view) {
        if (view.getId() == R.id.reg_reg) {
            ...
            Qual = qual.getText().toString().trim();
            ...
            if (thePhone.length() != 10 || !thePhone.startsWith("05")) {
                ...
                Toast.makeText(this, "Enter valid qualifications", Toast.LENGTH_LONG).show();
            }
            if (!error) {
                Registration();
            }
    ...
    private void Registration() {
        class RegAsync extends AsyncTask<String, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loadingDialog = ProgressDialog.show(VoluntReg.this, getResources().getString(R.string.wait), getResources().getString(R.string.connecting));
            }
            @Override
            ...
            protected void onPostExecute(String result) {
                ...
                if (result.isEmpty() || result.equals("Error"))
                    ...
                    Intent intent = new Intent(VoluntReg.this, MainActivity.class);
